...
export default function PreiviewAcceptedRequests({darkMode, friendshipId, profileId, profileName, profilePicture, status, profileAbout, toggleBlockPopup, toggleUnfriendPopup}) {
  return (

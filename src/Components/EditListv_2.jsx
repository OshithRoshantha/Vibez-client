...
export default function EditListing({ showYourListningMenu, darkMode }) {
  return (
    ...
    >
      <h2 className={`${darkMode ? 'text-white' : ''} text-lg font-semibold mb-4`}>
        Edit listing
      </h2>
      <div
      ...
      >
        <div className="mb-4">
          <input
            type="text"
            className={`${darkMode ? 'bg-[#262729] text-white placeholder:text-gray-400' : 'bg-white text-black placeholder:text-gray-500'} py-2 border rounded-lg p-2 w-full`}
        ...
        <div className="mb-4">
          <select
            className={`${darkMode ? 'bg-[#262729] text-gray-400' : 'bg-white text-gray-500'} border rounded-lg p-2 w-full`}
            style={{ outline: '1px solid #c1c3c7' }}
            defaultValue=""
          >

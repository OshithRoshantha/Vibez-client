...
export default function GroupMemberList({darkMode, members, groupName}) {
            ...
            member.userId === userId ? (
              <div key={member.userId} className="flex items-center mb-2">
                <div
                  ...
                  style={{ backgroundImage: `url(${member.profilePicture})`, backgroundSize: 'cover' }}
                ></div>
                <div>
              ...
              <div key={member.userId} className="flex items-center mb-2">
                ...
                <button
                  ...
                  className={`${darkMode ? 'bg-[#6a6b6d] text-white hover:bg-[#545454]' : 'bg-gray-300 text-gray-600 hover:bg-gray-200'} border-none ml-auto text-sm`}
                >
                  Remove
                </button>
              </div>

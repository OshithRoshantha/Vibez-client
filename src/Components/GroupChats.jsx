    ...
    <div>
        <div className="border-r border-border p-4 chats-column">
                ...
                <div className="flex space-x-2 mb-4">
                    <button onClick={showGroupChats} className="bg-gray-300 text-gray-600 px-4 py-2 rounded-full border-none hover:bg-gray-300">Your groups</button>
                    <button onClick={showAddMembersMenu} className="bg-gray-300 text-gray-600 px-4 py-2 rounded-full border-none hover:bg-gray-300"><i className="bi bi-plus-lg"></i></button>
                </div>

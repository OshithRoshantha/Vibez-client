...
export default function YourListings({showEditListingMenu, darkMode, productTitle, productDesc, productPhotos, price}) {
  ...
  return (  
    <div>
        ...
        <div>
            ...
            <p className={`${darkMode ? 'text-gray-400':'text-muted-foreground'} text-sm`}>{productDesc}</p>

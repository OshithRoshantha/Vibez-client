...
export default function PreviewProduct({darkMode, showProductInfo, productImage, productPrice, productTitle}) {
  return (
    <>
    <div className="bg-card rounded-lg shadow-md overflow-hidden" style={{height:'87%', cursor:'pointer',backgroundColor: darkMode ? '#56585a':''}} onClick={showProductInfo}>
        <img src={productImage} alt="Se2" className="w-full h-30 object-cover" style={{height:'65%'}}/>
